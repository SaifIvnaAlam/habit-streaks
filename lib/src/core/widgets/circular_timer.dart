...
import 'package:habitstreaks/src/core/widgets/circular_clock/circular_timer_painter.dart';
...
class CircularClock extends StatefulWidget {
  ...
  @override
  CircularClockState createState() => CircularClockState();
}

class CircularClockState extends State<CircularClock> with TickerProviderStateMixin {
...
class CountDownController {
  late CircularClockState _state;
